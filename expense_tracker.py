...
print("Track your daily and monthly expense on day to day basis")
...
# --- IGNORE ---
# End of recent edits
# This code is a simple expense tracker application that allows users to add and view expenses. 
# It includes a menu for user interaction and functions to handle expense addition and viewing.
# The application is designed to be user-friendly and can be extended with additional features like budget tracking and saving expenses.
